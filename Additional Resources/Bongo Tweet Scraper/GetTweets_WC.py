...
class TweetExtractor(object):
    ...
    def dump_tweets_to_json(self, path=app_config["app"]["json_path"]):
        with open(path, 'a') as output:
            for tweet in extractor.tweets:
...
if __name__ == '__main__':
    ...
    extractor.dump_tweets_to_json()

    do_ingest = input("Should I ingest the tweets? (y/n): ")
    if do_ingest=="y":
